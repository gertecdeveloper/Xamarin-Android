...
namespace Gpos700_XamrinAndroid.TEF
{
    ...
    public class Tef : AppCompatActivity
    {
        ...
        {
            acao = "funcoes";
            if (Mask.Unmask(valPag.Text.ToString()).Equals("0,00"))
            {
                dialogoErro("O valor de venda digitado deve ser maior que 0");
            }
            else if (rbMsitef.Checked && validaIp(ipEdit.Text.ToString()) == false)
            {
        ...
        private void execulteSTefFuncoes()
        {
            ...
            intentSitef.PutExtra("enderecoSitef", ipEdit.Text.ToString());
            ...
            intentSitef.PutExtra("valor", Mask.Unmask(valPag.Text.ToString().Replace(",", "").Replace(".", "")));
        ...
        private void enviarTransacao()
        {
            ...
            {
                if (rbCredito.Checked && (String.IsNullOrEmpty(qtdeParcelas.Text.ToString()) || qtdeParcelas.Text.ToString().Equals("0")))
                {
        ...
        private void execulteSTefVenda()
        {
            ...
            if (rbCredito.Checked)
            {
                ...
                if (qtdeParcelas.Text.ToString().Equals("0") || qtdeParcelas.Text.ToString().Equals("1"))
                {
                ...
                intentSitef.PutExtra("numParcelas", qtdeParcelas.Text.ToString());
            }
        ...
        private void execulteGer7Venda()
        {
            ...
            venda.amount = Mask.Unmask(valPag.Text.ToString().Replace(",", "").Replace(".", ""));
            //Console.WriteLine(venda.amount);
            venda.installments = Mask.Unmask(qtdeParcelas.Text.ToString());
