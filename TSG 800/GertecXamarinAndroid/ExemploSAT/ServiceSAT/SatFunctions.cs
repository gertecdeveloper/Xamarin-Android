...
namespace GertecXamarinAndroid.ExemploSAT.ServiceSAT
{
    ...
    class SatFunctions : Java.Lang.Throwable
    {
        ...
        public string CancelarUltimaVenda(string codAtivacao, string chave, int codigoSessao)
        {
            try
            {
                string dadosVenda = this.CarregarArquivo(arquivoXmlCancelamento).Replace("trocarCfe", chave);
                return serialComms.CancelarUltimaVenda(codigoSessao, codAtivacao, chave, dadosVenda);
            }
            catch (System.Exception e)
            {
                return e.Message;
        ...
        public string EnviarTesteVendas(string codAtivacao, int codigoSessao)
        {
            try
            {
                string dadosVenda = this.CarregarArquivo(arquivoXmlVendas);
        ...
        public string EnviarTesteFim(string codAtivacao, int codigoSessao)
        {
            try
            {
